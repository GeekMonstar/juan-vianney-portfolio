...
const toolsSection = document.querySelector('#tools-list');
const icons = {
    skills: {
...
tools.map(item => {
    toolsSection.innerHTML += `<div class="tool ${item.class}">
            ${item.svg}
                <p>${item.title}</p>
        </div>`
});

toolsElements = document.querySelectorAll('.tool');
toolsElements.forEach(item=>{
    console.log(item);
